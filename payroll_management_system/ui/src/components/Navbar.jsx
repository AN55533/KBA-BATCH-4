    ...
    <div className="flex">
      ...
      <div className="bg-blue-500 text-white w-64 h-screen shadow-md fixed p-6">
        ...
        <nav className="flex flex-col space-y-4">
          <Link to="/home" className="hover:bg-blue-700 p-2 rounded">
            Dashboard
          </Link>
          ...
          {/* <Link to="/profile/:EMPID" className="hover:bg-blue-700 p-2 rounded">
            My Profile
          </Link> */}
          <Link to="/salaryrecords" className="hover:bg-blue-700 p-2 rounded">
            Salary Reports
          </Link>
          <Link
            to="/logout"
